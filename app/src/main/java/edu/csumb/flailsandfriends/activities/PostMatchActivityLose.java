...
import edu.csumb.flailsandfriends.databinding.ActivityPostMatchLoseBinding;

public class PostMatchActivityLose extends AppCompatActivity {

    private static final String CHARACTER_SELECT_USER_ID = "edu.csumb.flailsandfriends.CHARACTER_SELECT_USER_ID";

    private static final int LOGGED_OUT = -1;

    private ActivityPostMatchLoseBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPostMatchLoseBinding.inflate(getLayoutInflater());
        ...
        setContentView(R.layout.activity_post_match_lose);
    ...
    public static Intent postMatchLoseIntentFactory(Context context) {
        return new Intent(context, PostMatchActivityLose.class);
    }
}